...
| `demo0.config.toml` | `~/.codex/lg-GATEWAY-mantle-on-demo0.config.toml` | second-account profile template (rename with your gateway and prefix) |
| `demo0-models.json` | `~/.codex/model-catalogs/lg-GATEWAY-mantle-on-demo0.json` | second-account catalog (generated by `tgw add-account`) |
