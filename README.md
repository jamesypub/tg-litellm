...
models) to an existing gateway — no Terraform required. Each account gets its own
namespace prefix (e.g. `demo0/openai.gpt-5.6-sol`), dedicated team, and virtual
key. See [admin.md → Adding a second AWS account](docs/admin.md#adding-a-second-aws-account).
